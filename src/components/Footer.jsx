      ...
      <div className="border-t" style={{borderColor: 'rgba(255,255,255,0.05)'}}>
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-6">
          ...
          <div className="text-center mt-4">
            <a href="https://syab.tech/mentee" target="_blank" rel="noopener noreferrer" className="text-[11px] transition-colors hover:text-[#4da6ff]" style={{color: 'rgba(255,255,255,0.25)'}}>
              Made by <span className="font-semibold" style={{color: 'rgba(255,255,255,0.4)'}}>syab.tech</span>
            </a>
          </div>
        </div>
      </div>
