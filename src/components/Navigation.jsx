...
export default function Navigation({ cartCount, favCount, categories }) {
  ...
  return (
    <header className="sticky top-0 z-50">
      ...
      {/* Desktop Category Nav - Jarir Style */}
      <div className="hidden lg:block sticky top-0 z-40 bg-white shadow-sm" style={{borderTop: '1px solid #f3f4f6', borderBottom: '1px solid #e5e7eb'}}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
